...
<%
	...
	//cate마다 최신글 db에서 가져오기
	ArticleDAO dao = new ArticleDAO();
	List<ArticleDTO> latests1 = dao.selecrLatests("grow", 5);
	List<ArticleDTO> latests2 = dao.selecrLatests("school", 5);
	List<ArticleDTO> latests3 = dao.selecrLatests("story", 5);
	
	List<ArticleDTO> tabLatest1 = dao.selecrLatests("notice", 3);
	List<ArticleDTO> tabLatest2 = dao.selecrLatests("qna", 3);
	List<ArticleDTO> tabLatest3 = dao.selecrLatests("faq", 3);
%>
        <main>
            <div class="slider">
                <ul>
